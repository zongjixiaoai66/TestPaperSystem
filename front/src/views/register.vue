  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.18);borderRadius:15px">
        <h1 class="h1" style="color:rgba(64, 158, 255, 1);fontSize:28px;">基于SSM的课程智能组卷系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="老师姓名" class="input" v-if="tableName=='laoshi'">
			  <el-input v-model="ruleForm.laoshixingming" autocomplete="off" placeholder="老师姓名" type="text" />
																														...
																														<!-- <div v-if="tableName=='laoshi'" class="input-group">
			   <div class="label">老师手机</div>
			   <div class="input-container">
			     <input v-model="ruleForm.laoshishouji" class="input" type="text" placeholder="老师手机">
			   </div>
			 </div> -->
			<el-form-item label="老师手机" class="input" v-if="tableName=='laoshi'">
			  <el-input v-model="ruleForm.laoshishouji" autocomplete="off" placeholder="老师手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='laoshi'" class="input-group">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.laoshixingming) && `laoshi` == this.tableName){
        this.$message.error(`老师姓名不能为空`);
        return
      }
                                                                                                                                                                                                      if(`laoshi` == this.tableName && this.ruleForm.laoshishouji&&(!this.$validate.isMobile(this.ruleForm.laoshishouji))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://r874yyuf4.hb-bkt.clouddn.com/bg2.jpg");
		height: 100vh;
