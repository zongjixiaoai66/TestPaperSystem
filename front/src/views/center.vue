     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='laoshi'"  label="老师姓名" prop="laoshixingming">
          <el-input v-model="ruleForm.laoshixingming"               placeholder="老师姓名" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="flag=='laoshi'" label="出生日期" prop="chushengriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chushengriqi" 
        ...
        <el-form-item   v-if="flag=='laoshi'"  label="老师手机" prop="laoshishouji">
          <el-input v-model="ruleForm.laoshishouji"               placeholder="老师手机" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='laoshi'"  label="老师邮箱" prop="laoshiyouxiang">
          <el-input v-model="ruleForm.laoshiyouxiang"               placeholder="老师邮箱" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="24">  
        <el-form-item v-if="flag=='laoshi'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.zhaopian?ruleForm.zhaopian:''"
          @change="laoshizhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
        ...
        this.ruleForm.zhaopian = fileUrls;
                                                                                        ...
                                                                                        laoshizhaopianUploadChange(fileUrls) {
        this.ruleForm.zhaopian = fileUrls;
    },
                                                    onUpdateHandler() {
        ...
        return
                                                                        ...
                                                                        if( 'laoshi' ==this.flag && this.ruleForm.laoshiyouxiang&&(!isEmail(this.ruleForm.laoshiyouxiang))){
        this.$message.error(`老师邮箱应输入邮箱格式`);
        return
      }
                                                                                                                                                this.$http({
